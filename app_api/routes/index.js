...
router.get('/user', ctrlUsers.getUsersList);
...
router.get('/user/:userid/articles', ctrlArticles.getAriclesList);
...
router.get('/user/:userid/events', ctrlEvents.getEventsList);
